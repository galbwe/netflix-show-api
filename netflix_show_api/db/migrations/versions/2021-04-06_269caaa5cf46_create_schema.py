...
Revision ID: 269caaa5cf46
Revises: 
Create Date: 2021-04-06 22:58:42.240769
...
def upgrade():
    ...
    sa.Column('modified', sa.DateTime(), nullable=True),
    sa.Column('deleted', sa.DateTime(), nullable=True),
    sa.Column('netflix_show_id', sa.String(length=100), nullable=True),
    ...
    sa.Column('cast_member_id', postgresql.UUID(), nullable=True),
